...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        # Keep the SO follower wrist roll 90 degrees ahead of the leader.
        if robot.name == "so_follower" and "wrist_roll.pos" in robot_action_to_send:
            robot_action_to_send = dict(robot_action_to_send)
            wrist_roll = robot_action_to_send["wrist_roll.pos"] - 90.0
            robot_action_to_send["wrist_roll.pos"] = (wrist_roll + 180.0) % 360.0 - 180.0
