...
from lerobot.utils.hub import find_latest_hub_checkpoint, normalize_hub_repo_id


def test_normalize_hub_repo_id_converts_windows_separators():
    assert normalize_hub_repo_id(r"lerobot\smolvla_base") == "lerobot/smolvla_base"


def test_normalize_hub_repo_id_preserves_posix_separators():
    assert normalize_hub_repo_id("lerobot/smolvla_base") == "lerobot/smolvla_base"
